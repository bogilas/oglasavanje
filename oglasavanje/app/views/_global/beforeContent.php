...
<html lang="sr">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
      <div class="container">
          <a class="navbar-brand" href="<?php echo Configuration::BASE_URL ?>">Bocgilas</a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item">
                <a class="nav-link" href="<?php echo Configuration::BASE_URL ?>">Pocetna</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<?php echo Configuration::BASE_URL ?>preduzeca">Preduzeca</a>
            </li>
            <li class="nav-item">
        ...
        <div class="row">
          <div class="col-lg-8 col-md-10 mx-auto">
            <div class="site-heading">
              ...
              <span class="subheading">Najbolje oglasavanje pravnih lica u regionu</span>
            </div>
          </div>
        </div>
      </div>
